...
'''
NOTE: the original structure of these objects was to have a ParmFile object with a collection of child BlockingPass objects.
...
class BigmatchParmfile():
    ...
    recfile_record_length = 200
    memfile_record_length = 200
    parm_counter = None	
    parms = []	
...
class BigmatchParmRow():
    ...
    def __init__(self, master, row_index, rowtext=None, row_type=''):
        ...
        #*****************************************************
        #ParseRow() functions populate this instance and also populate Parmfile_BlockingPass instances. 
        self.parse_row()
        #*****************************************************
